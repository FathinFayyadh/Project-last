                            ...
                            <div class="card p-1 ">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <p
                                            class="card-text bg-success p-1 rounded text-white @if (strtolower($product->kondisi) == 'baru') bg-success @else bg-warning @endif">
                                            {{ $product->kondisi }}
                                    </div>
                                    ...
                                    <a href="{{route('checkout.create', $product->id)}}" class="btn btn-primary">Pesan sekarang</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
